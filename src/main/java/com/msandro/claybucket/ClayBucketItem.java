...
public class ClayBucketItem extends Item {
    ...
    public ClayBucketItem(Fluid fluid, Item.Settings settings) {
        super(settings);
        this.fluid = fluid;
    }
                ...
                if (this.fluid == Fluids.EMPTY) {
                    ...
                    if (blockState.getBlock() instanceof FluidDrainable) {
                        ...
                        if (fluid_item != ItemStack.EMPTY) {
                            ...
                            ItemStack item = null;
                            if (fluid_item.getItem() == Items.LAVA_BUCKET || fluid_item.getItem() == com.msandro.claybucket.ModRegistry.LAVA_CLAY_BUCKET) {
                                item = new ItemStack(com.msandro.claybucket.ModRegistry.LAVA_CLAY_BUCKET);
                            } else if (fluid_item.getItem() == Items.WATER_BUCKET || fluid_item.getItem() == com.msandro.claybucket.ModRegistry.WATER_CLAY_BUCKET) {
                                item = new ItemStack(com.msandro.claybucket.ModRegistry.WATER_CLAY_BUCKET);
                            }
                            if(item!=null){
    ...
    protected ItemStack getEmptiedStack(ItemStack stack, PlayerEntity player) {
        ...
        return !player.getAbilities().creativeMode ? new ItemStack(ModRegistry.CLAY_BUCKET) : stack;
    }
